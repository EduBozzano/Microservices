...
require('dotenv').config(); //cargamos las variables definidas en el archivo .env para acceder a ellas luego
...
const PORT = Number(process.env.PORT) || 3000; //el puerto del env devuelve un string entonces lo parseamos a un numero
